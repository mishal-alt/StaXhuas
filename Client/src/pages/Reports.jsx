      ...
      <AppShell>
        <Box sx={{ py: 4, display: 'flex', flexDirection: 'column', gap: 6 }}>
          ...
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 2 }}>
            <Box>
              <Typography variant="h4" color="secondary" gutterBottom sx={{ fontSize: { xs: '2rem', md: '3rem' } }}>
              ...
              <Stack direction="row" spacing={1} alignItems="center">
                ...
                <Typography variant="caption" fontWeight={900} color="text.secondary" sx={{ letterSpacing: '0.2em' }}>
                  REPOSITORY SYNC: LIVE ANALYTICS ENGINE
                </Typography>
              </Stack>
            </Box>
            <Stack direction="row" spacing={2}>
              ...
              <Button variant="contained" startIcon={<Download />} disableElevation>
                Export Ledger
              </Button>
            </Stack>
          </Box>
